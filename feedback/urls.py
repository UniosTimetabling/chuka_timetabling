...
from . import feedback_panel, views, chat_view, challenge_views
...
urlpatterns = [
    ...
    # ── System Challenge Log (shown on the Timetable Dashboard) ────────────
    path("system-challenges/",                challenge_views.challenge_dashboard,   name="challenge_dashboard"),
    path("system-challenges/save/",           challenge_views.challenge_save,        name="challenge_save"),
    path("system-challenges/<int:pk>/delete/", challenge_views.challenge_delete,     name="challenge_delete"),
    path("system-challenges/export/excel/",   challenge_views.challenge_export_excel, name="challenge_export_excel"),
    path("system-challenges/export/pdf/",     challenge_views.challenge_export_pdf,  name="challenge_export_pdf"),
    path("system-challenges/reimport/",       challenge_views.challenge_reimport,    name="challenge_reimport"),
]
