...
from .models import Feedback, FeedbackAttachment, SystemChallenge
...
@admin.register(SystemChallenge)
class SystemChallengeAdmin(admin.ModelAdmin):
    list_display = (
        "reference_code", "title", "classification", "status",
        "occurred_at", "resolved_at", "created_by",
    )
    list_filter = ("classification", "status", "occurred_at")
    search_fields = ("reference_code", "title", "description", "cause", "involved_parties")
