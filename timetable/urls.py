...
urlpatterns=[
    ...
    path('exam/timetable/placement-hints/', exam_timetable_panel.exam_placement_hints_api, name='exam_placement_hints_api'),
]
...
urlpatterns += [
   ...
   path('timetable/', timetable_panel.timetable_panel, name='timetable_panel'),
    ...
    path('timetable/issues-map/', issue_tracking.timetable_issues_map_api, name='timetable_issues_map_api'),
    ...
    # ── Course-family aware placement (left-behind family member + same-code sibling groups) ──
    path('exam/timetable/family/left-behind/', exam_family_resolve.exam_family_left_behind_api, name='exam_family_left_behind_api'),
    path('exam/timetable/family/resolve-options/', exam_family_resolve.exam_family_resolve_options_api, name='exam_family_resolve_options_api'),
    path('exam/timetable/family/resolve-execute/', exam_family_resolve.exam_family_resolve_execute_api, name='exam_family_resolve_execute_api'),
    path('exam/timetable/family/group-preview/', exam_family_resolve.exam_family_group_preview_api, name='exam_family_group_preview_api'),
    path('exam/timetable/family/group-execute/', exam_family_resolve.exam_family_group_execute_api, name='exam_family_group_execute_api'),
    ...
    # Main dashboard page
    # ── Lab Timetable panel (embedded in /timetable/) ───────────────────────
    path('timetable/lab/load-data/', lab_panel_ops.load_lab_timetable_data, name='load_lab_timetable_data'),
    path('timetable/lab/save/', lab_panel_ops.save_lab_entry, name='save_lab_entry'),
    path('timetable/lab/delete/', lab_panel_ops.delete_lab_entry, name='delete_lab_entry'),
    path('timetable/lab/update-student-count/', lab_panel_ops.update_lab_student_count_api, name='update_lab_student_count_api'),
    path('timetable/lab/move/simulate/', lab_panel_ops.simulate_lab_move_api, name='simulate_lab_move_api'),
    path('timetable/lab/move/execute/', lab_panel_ops.execute_lab_move_api, name='execute_lab_move_api'),
    path('timetable/lab/swap/simulate/', lab_panel_ops.simulate_lab_swap_api, name='simulate_lab_swap_api'),
    path('timetable/lab/swap/execute/', lab_panel_ops.execute_lab_swap_api, name='execute_lab_swap_api'),
    path('timetable/lab/copy/simulate/', lab_panel_ops.simulate_lab_copy_api, name='simulate_lab_copy_api'),
    path('timetable/lab/copy/execute/', lab_panel_ops.execute_lab_copy_api, name='execute_lab_copy_api'),
    path('timetable/lab/combine/simulate/', lab_panel_ops.simulate_lab_combine_api, name='simulate_lab_combine_api'),
    path('timetable/lab/combine/execute/', lab_panel_ops.execute_lab_combine_api, name='execute_lab_combine_api'),
    path('timetable/lab/combine/remove/', lab_panel_ops.remove_from_lab_combine_api, name='remove_from_lab_combine_api'),
    path('timetable/lab/bulk-move/', lab_panel_ops.lab_bulk_move_api, name='lab_bulk_move_api'),
    path('timetable/lab/find/filter-options/', lab_panel_ops.lab_find_filter_options_api, name='lab_find_filter_options_api'),
    path('timetable/lab/find/courses/', lab_panel_ops.lab_find_courses_api, name='lab_find_courses_api'),
    path('timetable/lab/config/update/', lab_panel_ops.update_lab_scheduler_config_api, name='update_lab_scheduler_config_api'),
    ...
    path('timetable/analysis/program-partitions/', analysis_reports.analysis_program_partitions_api, name='analysis_program_partitions_api'),
    ...
    path('timetable/analysis/sharing-settings/', analysis_reports.analysis_sharing_settings_api, name='analysis_sharing_settings_api'),
    path('timetable/analysis/sharing-settings/update/', analysis_reports.update_analysis_sharing_settings, name='update_analysis_sharing_settings'),

    # Allocation Set switcher — same session-wide active set as /timetable/dashboard/
    path('timetable/analysis/allocation-sets/', analysis_reports.analysis_allocation_sets_api, name='analysis_allocation_sets_api'),
    path('timetable/analysis/allocation-sets/apply/', analysis_reports.apply_analysis_allocation_sets, name='apply_analysis_allocation_sets'),
]
