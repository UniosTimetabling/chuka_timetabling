...
class ProgramCourse(models.Model):
    # Extended for the concurrent-AllocationSet upgrade: some departments run
    # a 3rd semester (special/intersession). Widening the choices list is a
    # non-breaking, additive change — existing rows with semester=1 or 2 are
    # untouched, and the underlying field was always a plain integer.
